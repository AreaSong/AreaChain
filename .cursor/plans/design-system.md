...
### P6 颜色、字号、圆角清扫（按模块做）
菜单栏已完成。下一份是任务模块：`design-system-P6-tasks-execute.md` / `design-system-P6-tasks-verify.md`。规则与菜单栏相同：误差不超过 0.5pt 才换令牌；小于 9pt、圆体、等宽保持原样并写 `token-exempt`。手记、工作台、其余页面和 Theme 仍各写一份。
