...
| 搜索结果 | `BoardSearchHitRow`、`SearchResultsView`、`WorkspaceGlobalSearchView` | [BoardSearchHitRow.swift](../AreaChain/Features/Search/BoardSearchHitRow.swift)、[SearchResultsView.swift](../AreaChain/Features/Search/SearchResultsView.swift)、[WorkspaceGlobalSearchView.swift](../AreaChain/Features/Workspace/WorkspaceGlobalSearchView.swift) | 复用结果路由、隐私投影、父任务信息和重复事项日期；搜索本身只读。没有独立搜索页。 |
